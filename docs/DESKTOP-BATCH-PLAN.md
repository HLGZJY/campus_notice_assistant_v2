...
| B22 | 发布 v0.2.0 | 进行中 | 009e764 | 6d8f748 | 2.0 | 自动项全绿（回归43/43、文档齐备、v0.2.0安装包已构建）；发布核查修复 P1 更新闭环（latest.json ASCII 名+CI 上传）；真机L5勾验与7天稳定性、Release push 待用户介入 | B22-发布v0.2.0-验收记录.md |
