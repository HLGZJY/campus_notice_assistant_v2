...
| B22 | 发布 v0.2.0 | 进行中 | 009e764 | c3b737b | 2.0 | 自动项全绿（回归43/43、文档齐备、v0.2.0安装包已重建）；发布核查修复 P1 更新闭环（ASCII 名+CI 上传）与 P1 令牌注入时序（用户实测）；真机L5勾验与7天稳定性、Release push 待用户介入 | B22-发布v0.2.0-验收记录.md |
