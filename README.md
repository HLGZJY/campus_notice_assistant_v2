...
- **评估闭环**：黄金集 24/24（提取）、100%（截止时间解析）、20 题检索测试集、43 个验收测试脚本——每个 Agent 环节都有可复现的度量。
...
- [x] **桌面化 v0.2.0**：pywebview 原生窗口 + 托盘 / 单实例 / 自启 / 更新闭环，免终端免浏览器独立启动（方案见 [DESKTOP-UPGRADE.md](docs/DESKTOP-UPGRADE.md)）
